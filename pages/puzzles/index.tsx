...
const PuzzlesPage: NextPage = () => {
  ...
  class PuzzleDemo {
    ...
    private setDifficultyStyle_() {
      ...
      this.map_.set('styles', styles.easy)
    }
     ...
     */
    private boundsContainsPoly_(bounds: number[][], poly: google.maps.Polygon): boolean {
  ...
  const handleApiLoaded = () => {
    const puzzleMap = new window.google.maps.Map(document.getElementById('map') as HTMLElement, {
      disableDefaultUI: true,
      center: { lat: 10, lng: 60 },
      zoom: 2,
    })

    new PuzzleDemo(puzzleMap)
  }
